...
public class EnergyTrashcanBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory, SidedInventory {
    ...
    protected void writeNbt(NbtCompound nbt) {
        super.writeNbt(nbt);
        nbt.putLong(("energy_trashcan.energy"), this.energyStorage.amount);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        super.readNbt(nbt);
        this.energyStorage.amount = nbt.getLong("energy_trashcan.energy");
    }
    ...
    public Text getDisplayName() {
        return Text.literal("Energy Trashcan");
    }

    @Nullable
    @Override
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new EnergyTrashcanScreenHandler(syncId, playerInventory, this);
    }
