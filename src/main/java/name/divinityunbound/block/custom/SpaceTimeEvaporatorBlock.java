...
public class SpaceTimeEvaporatorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public SpaceTimeEvaporatorBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SpaceTimeEvaporatorBlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof SpaceTimeEvaporatorBlockEntity) {
                ItemScatterer.spawn(world, pos, (SpaceTimeEvaporatorBlockEntity)blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((SpaceTimeEvaporatorBlockEntity) world.getBlockEntity(pos));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.SPACE_TIME_EVAPORATOR_BLOCK_ENTITY,
