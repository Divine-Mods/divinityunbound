...
import name.divinityunbound.block.entity.PersephonesBlessingBlockEntity;
...
public class PersephonesBlessingBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new PersephonesBlessingBlockEntity(pos, state);
    }
    ...
    private void updateUpgrades(World world, BlockPos pos) {
        ...
        if (be instanceof PersephonesBlessingBlockEntity) {
            ((PersephonesBlessingBlockEntity)be).resetUpgrades();
...
//        if (!world.isClient) {
//            NamedScreenHandlerFactory screenHandlerFactory = ((PersephonesBlessingBlockEntity) world.getBlockEntity(pos));
//
...
//    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.PERSEPHONES_BLESSING_BLOCK_ENTITY,
