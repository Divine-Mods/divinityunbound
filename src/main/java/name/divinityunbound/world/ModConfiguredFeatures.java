...
public class ModConfiguredFeatures {
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, CELESTITE_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldCelestiteOres, 7));
        register(context, EXPERIENCE_ORE_KEY, Feature.ORE, new OreFeatureConfig(overworldExperienceOres, 4));
