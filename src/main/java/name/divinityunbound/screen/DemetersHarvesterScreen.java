...
public class DemetersHarvesterScreen extends HandledScreen<DemetersHarvesterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(DivinityUnbound.MOD_ID, "textures/gui/demeters_harvester_gui.png");
    private EnergyInfoArea energyInfoArea;
//    private FluidStackRenderer fluidStackRenderer;
//    private long fluidCapacity;

    public DemetersHarvesterScreen(DemetersHarvesterScreenHandler handler, PlayerInventory inventory, Text title) {
