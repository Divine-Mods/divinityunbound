...
public class PortunusPropagatorScreen extends HandledScreen<PortunusPropagatorScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(DivinityUnbound.MOD_ID, "textures/gui/portunus_propagator_gui.png");
    private EnergyInfoArea energyInfoArea;
//    private FluidStackRenderer fluidStackRenderer;
//    private long fluidCapacity;

    public PortunusPropagatorScreen(PortunusPropagatorScreenHandler handler, PlayerInventory inventory, Text title) {
