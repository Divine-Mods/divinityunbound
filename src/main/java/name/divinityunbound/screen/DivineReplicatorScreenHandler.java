...
public class DivineReplicatorScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final DivineReplicatorBlockEntity blockEntity;

    public DivineReplicatorScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public DivineReplicatorScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.addSlot(new Slot(inventory, 2, 8, 59));
